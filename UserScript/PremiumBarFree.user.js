...
<tbody><tr>
    ...
    <li class="quickbar_item" name="/game.php?screen=welcome&intro&oscreen=overview_villages">
            <img src="https://snipboard.io/4RtSKY.jpg">
            <div>Tela Inicial</div>
        </li>
        <li class="quickbar_item" name="/game.php?screen=map">
            <img src="https://snipboard.io/JxBmij.jpg">
            <div>Mapa</div>
        </li>
        <li class="quickbar_item" name="/game.php?screen=overview">
            <img src="https://snipboard.io/JxBmij.jpg">
            <div>Aldeia</div>
        </li>
       <li class="quickbar_item" name="/game.php?screen=main">
            <img src="https://snipboard.io/4RtSKY.jpg">
            <div>Edificio Principal</div>
        </li>
        <li class="quickbar_item" name="/game.php?screen=train">
            <img src="https://snipboard.io/oUqVs6.jpg">
            <div>Recrutar</div>
        </li>
        <li class="quickbar_item" name="/game.php?screen=place">
            <img src="https://snipboard.io/GHpEjW.jpg">
            <div>Praça de Reunião</div>
            <ul>
                <li class="quickbar_item" name="/game.php?screen=place&mode=sim" rowspan="1">
                    <div>
                        <img src="/graphic/big_buildings/place1.png">
                        &nbsp;&nbsp;Simulador
                    </div>
                </li>
                <li class="quickbar_item" name="/game.php?screen=place&mode=units" rowspan="1">
                    <div>
        ...
        <li class="quickbar_item" name="/game.php?screen=market">
            <img src="https://snipboard.io/2f70rF.jpg">
            <div>Mercado</div>
             <ul>
                <li class="quickbar_item" name="/game.php?screen=market&mode=exchange" rowspan="1">
                    <div>
                        <img src="/graphic/res.png">
                        &nbsp;&nbsp;Troca Premium
                    </div>
                </li>
                <li class="quickbar_item" name="/game.php?screen=market&mode=own_offer" rowspan="1">
                    <div>
                        <img src="/graphic/res.png">
                        &nbsp;&nbsp;Criar Ofertas
                    </div>
                </li>
               <li class="quickbar_item" name="/game.php?screen=market&mode=send" rowspan="1">
                    '<div>
                        '<img src="/graphic/res.png">
                        '&nbsp;&nbsp;Enviar Recursos
                    </div>
                </li>
               <li class="quickbar_item" name="/game.php?screen=market&mode=transports" rowspan="1">
                    <div>
                        <img src="/graphic/res.png">
                        &nbsp;&nbsp;Transporte
                    </div>
                </li>
               <li class="quickbar_item" name="/game.php?screen=market&mode=traders" rowspan="1">
                    <div>
                        <img src="/graphic/res.png">
                        &nbsp;&nbsp;Estado Comerciante
                    </div>
                </li>
             <li class="quickbar_item" name="/game.php?screen=market&mode=all_own_offer" rowspan="1">
                    <div>
                        <img src="/graphic/res.png">
                        &nbsp;&nbsp;Todas Suas Ofertas
                    </div>
        ...
        <li class="quickbar_item" name="/game.php?screen=smith">
            <img src="https://snipboard.io/3PZtYU.jpg">
            <div>Ferreiro</div>
        </li>
        <li class="quickbar_item" name="/game.php?screen=snob">
            <img src="https://snipboard.io/qYBDNg.jpg">
            <div>Academia</div>
        </li>
    <li class="quickbar_item" name="/game.php?&screen=church">
            <img src="graphic/big_buildings/church1.png">
            <div>Igreja</div>
        </li>
         <li class="quickbar_item" name="#">
            <div id="by"> Bara Premiun Free <br>
			by <a class="quickbar_link" data-hash="531033c83a8f03f6e0aeefc105d5f26c" href="https://github.com/albertonecosta" data-title="MaxximosDcost">MaxximosDcost</a><br>
			 & <a class="quickbar_link" data-hash="9eb912ebc499d8df40838bcb1e766d82" href="https://www.youtube.com/@ocriadordetrols5877/playlists" data-title="TyrannusRex">TyrannusRex</a></div>
        </li>
    	</td>
					<td class="right"> </td>
								</tr>
